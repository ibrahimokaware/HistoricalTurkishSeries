...
public class MostWatchedFragment extends Fragment {
    ...
    public static MostWatchedFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_most_watched, container, false);
    }
    ...
    public void readData(final LatestEpisodesFragment.MyCallback myCallback) {
        episodesReference
